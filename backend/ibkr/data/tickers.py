"""S&P 500 and Nasdaq-100 constituents (as of May 2026)."""
...
SP500: list[str] = [
    ...
    "BBWI","BAX","BDX","BBY","BIO","BIIB","BLK","BX","BA","BSX","BMY","AVGO",
    "BR","BRO","BLDR","BG","CDNS","CZR","CPT","CPB","COF","CAH","KMX","CCL",
    "CARR","CAT","CBOE","CBRE","CDW","CE","COR","CNC","CNX","CDAY","CF","CRL",
    ...
    "CMI","CVS","DHR","DRI","DVA","DAY","DECK","DE","DELL","DAL","DVN","DXCM",
    "FANG","DLR","DFS","DG","DLTR","D","DPZ","DOV","DHI","DTE","DUK","DD",
    "EMN","ETN","EBAY","ECL","EIX","EW","EA","ELV","EMR","ENPH","ETR","EOG",
    "EPAM","EQT","EFX","EQIX","EQR","ESS","EL","ETSY","EG","ES","EXC","EXPE",
    "EXPD","EXR","XOM","FFIV","FDS","FICO","FAST","FRT","FDX","FIS","FITB",
    "FSLR","FE","FI","FMC","F","FTNT","FTV","FOXA","FOX","BEN","FCX","GRMN",
    "IT","GE","GEHC","GEV","GEN","GNRC","GD","GIS","GM","GPC","GILD","GS",
    ...
    "SBUX","STT","STLD","STE","SYK","SYF","SNPS","SYY","TMUS","TROW","TTWO",
    ...
    "VRTX","VIAV","VST","V","VFC","VTRS","VICI","VNO","VMC","WRB","GWW","WAB",
    "WMT","DIS","WBD","WM","WAT","WEC","WFC","WELL","WST","WDC","WY","WMB",
    "WTW","WYNN","XEL","XYL","YUM","ZBRA","ZBH","ZTS",
]

NASDAQ100: list[str] = [
    "ADBE","ADP","ADSK","AEP","AMAT","AMD","AMGN","AMZN","ANSS","APP","ASML",
    "AVGO","AZN","BIIB","BKNG","BKR","CDNS","CDW","CEG","CHTR","CMCSA","COST",
    "CPRT","CRWD","CSCO","CSGP","CSX","CTAS","CTSH","DDOG","DLTR","DXCM","EA",
    "EXC","FANG","FAST","FTNT","GEHC","GFS","GILD","GOOG","GOOGL","HON","IDXX",
    "INTC","INTU","ISRG","KDP","KHC","KLAC","LRCX","LULU","MAR","MCHP","MDLZ",
    "MELI","META","MNST","MRNA","MRVL","MSFT","MU","NFLX","NVDA","NXPI","ODFL",
    "ON","ORLY","PANW","PAYX","PCAR","PDD","PEP","PLTR","PYPL","QCOM","REGN",
    "ROP","ROST","SBUX","SMCI","SNPS","TEAM","TMUS","TSLA","TTD","TTWO","TXN",
    "VRSK","VRTX","WBD","WDAY","XEL","ZS",
]

# Special symbol mappings for IBKR (symbol → IBKR symbol)
IBKR_SYMBOL_MAP: dict[str, str] = {
    "BRK.B": "BRK B",
    "BF.B": "BF B",
}

# High-volume leveraged ETFs added to the watchlist alongside Nasdaq-100
LEVERAGED_ETFS: list[str] = ["SOXL", "TQQQ", "UPRO"]

# Combined watchlist: Nasdaq-100 + leveraged ETFs
ALL_TICKERS: list[str] = sorted(set(NASDAQ100 + LEVERAGED_ETFS))
